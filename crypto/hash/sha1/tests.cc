...
const std::vector<NISTVector> NISTVectors {
    { "",
...
const std::vector<HMACVector> HMACVectors{
    { "0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b", true,
      "Hi There",
    ...
    { "0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c", true,
...
const crypto::HashFunctionFactory defaultImpl = []() { return crypto::SHA1Base_u(new crypto::SHA1Impl()); };

// Test default implementation
TEST(SHA1, NISTVectors) {
    for (auto vector : NISTVectors) {
        crypto::bytestring input =
            crypto::bytestring::from_hex(vector.input);

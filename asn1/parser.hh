 ...
 *
 * Features not supported include multibyte tag values and encoding switching
 * using control sequences.  Support for those may be added provided that
 * samples of valid use cases from real-life cryptographic applications would
 * be added into the test suite.
 *
